...
def load_models():
    ...
    try:
        ...
        models['ridge'] = joblib.load('../data/models/cmapss/ridge_model.pkl')
        models['random_forest'] = joblib.load('../data/models/cmapss/rf_model.pkl')
        models['gradient_boosting'] = joblib.load('../data/models/cmapss/gb_model.pkl')
        
        # Load survival models
        models['weibull'] = joblib.load('../data/models/cmapss/waft.pkl')
        models['cox'] = joblib.load('../data/models/cmapss/cph.pkl')
        
        # Load LSTM model
        models['lstm'] = keras.models.load_model('../data/models/cmapss/lstm_model.keras')
...
def load_test_data():
    """Load test dataset"""
    try:
        df_gold = pd.read_csv('../data/gold/cmapss/FD001_top_features.csv')
